              ...
              <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
                ...
                >
                  <Tab
                    ...
                    iconPosition="start"
                  />
                  <Tab label="Incisor" value="2" />
                  <Tab label="Molar" value="3" />
                </TabList>
              </Box>
              <TabPanel value="1">
                <Box
                  ...
                  justifyItems="center"
                  style={{ marginTop: "10px", marginLeft: "15rem" }}
                >
                  <img style={{width: "100%"}}  src="./Images/canineq.jpg" />
                </Box>
              </TabPanel>
              <TabPanel value="2">
                {" "}
